...
Скачиваем данные по пассажирам Титаника с [kaggle](https://www.kaggle.com/c/titanic/data)

Создаем директорию для хранения данных
```SQL
hdfs dfs -mkdir /user/hive/warehouse/titanic
```
Копируем данные в hdfs
```SQL
hdfs dfs -copyFromLocal titanic.csv /user/hive/warehouse/titanic/
```
![image](https://github.com/user-attachments/assets/686753b2-f340-4a20-9e18-78e06d05a653)
